    ...
    <script>
        function regValidation() {
            ...
            if (document.getElementById('subject').value == "") {
                ...
                document.getElementById('name').focus();
                document.getElementById('subject_error').innerHTML = "User is required";
                return false;
            }
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light fixed-top shadow py-lg-0 px-4 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand d-block d-lg-none">
            <h1 class="text-primary fw-bold m-0">its me</h1>
        </a>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                    ...
                    <h1 class="display-3 mb-3">Piyush</h1>
                    <h2 class="typed-text-output d-inline"></h2>
                    <div class="typed-text d-none">Web Developer, PHP Developer, Front End and Backend Developer, Web Designer </div>
                    <div class="d-flex align-items-center pt-5">
                        <a href="" class="btn btn-primary py-3 px-4 me-5" download="RESUMEEE.pdf">Download CV</a>
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="img/pkimages.png" alt="">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-6">
                            <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <h6 class="font-weight-bold">38%</h6>
                                </div>
                                <div class="progress">
                                    <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
            ...
            <div class="row g-4">
                        ...
                        <div class="row g-5 mb-5 align-items-center wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <div class="col-lg-6 text-lg-end">
                                <ul class="list-inline mx-n3 mb-0" id="portfolio-flters">
                                    <li class="mx-3 active" data-filter="*">PHP Projects</li>
                                    <li class="mx-3" data-filter=".first">Crud App</li>
                                    <li class="mx-3" data-filter=".second">TODO App</li>
                                </ul>
                            </div>
                        </div>
                        <div class="row g-4 portfolio-container wow fadeInUp" data-wow-delay="0.1s">
                            <div class="col-lg-4 col-md-6 portfolio-item first">
                                <div class="portfolio-img rounded overflow-hidden">
                                    ...
                                    <div class="portfolio-btn">
                                        <a class="btn btn-lg-square btn-outline-secondary border-2 mx-1" href="img/pr1.png" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                            ...
                            <div class="col-lg-4 col-md-6 portfolio-item second">
                                <div class="portfolio-img rounded overflow-hidden">
                                    ...
                                    <div class="portfolio-btn">
                                        <a class="btn btn-lg-square btn-outline-secondary border-2 mx-1" href="img/pr2.png" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                        <a class="btn btn-lg-square btn-outline-secondary border-2 mx-1" href=""><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 portfolio-item first">
                                <div class="portfolio-img rounded overflow-hidden">
                                    ...
                                    <div class="portfolio-btn">
                                        <a class="btn btn-lg-square btn-outline-secondary border-2 mx-1" href="img/pr3.png" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                        <a class="btn btn-lg-square btn-outline-secondary border-2 mx-1" href=""><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 portfolio-item second">
                                <div class="portfolio-img rounded overflow-hidden">
                                    ...
                                    <div class="portfolio-btn">
                                        <a class="btn btn-lg-square btn-outline-secondary border-2 mx-1" href="img/pr4.png" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                        <a class="btn btn-lg-square btn-outline-secondary border-2 mx-1" href=""><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 portfolio-item first">
                                <div class="portfolio-img rounded overflow-hidden">
                                    ...
                                    <div class="portfolio-btn">
                                        <a class="btn btn-lg-square btn-outline-secondary border-2 mx-1" href="img/project1.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                        <a class="btn btn-lg-square btn-outline-secondary border-2 mx-1" href=""><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 portfolio-item second">
                                <div class="portfolio-img rounded overflow-hidden">
                                    ...
                                    <div class="portfolio-btn">
                                        <a class="btn btn-lg-square btn-outline-secondary border-2 mx-1" href="img/project2.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                        <a class="btn btn-lg-square btn-outline-secondary border-2 mx-1" href=""><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container py-5">
                        ...
                        <div class="row g-5">
                            <div class="col-lg-5 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <h3 class="fw-bold">8539886607</h3>
                                <hr class="w-100">
                                <p class="mb-2">Mail me:</p>
                                <h3 class="fw-bold">pksharma8539@gmail.com</h3>
                                <hr class="w-100">
                                <p class="mb-2">Follow me:</p>
                                <div class="d-flex pt-2">
                                    <!-- <a class="btn btn-square btn-primary me-2" href=""><i class="fab fa-twitter"></i></a> -->
                                    <a class="btn btn-square btn-primary me-2" href="https://www.facebook.com/piyush3sharm" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square btn-primary me-2" href="https://www.youtube.com/channel/UCJXrglk6rBV4bpk3a-0N9GA/featured" target="_blank"><i class="fab fa-youtube"></i></a>
                                    <a class="btn btn-square btn-primary me-2" href="https://www.linkedin.com/in/piyush-sharma-b8aab318b" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-6 wow fadeInUp" data-wow-delay="0.5s">

                                <!-- connecting to the database... will show the message confirm or not -->
                                <?php include('server.php'); ?>

                                <h4>Send a Message...</h4>


                                <form name="contactform" method="POST" action="" class="contact" id="contactform" onsubmit="return regValidation()">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" onblur="checkValue(this)" name="name" class="form-control" id="name" placeholder="Your Name">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="email" onblur="checkValue(this)" name="email" class="form-control" id="email" placeholder="Your Email">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="text" onblur="checkValue(this)" name="subject" class="form-control" id="subject" placeholder="Subject">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="tel" onblur="checkValue(this)" name="mobile" class="form-control" id="mobile" placeholder="Mobile">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <textarea class="form-control" name="message" onblur="checkValue(this)" id="message" placeholder="Leave a message here" style="height: 100px"></textarea>
                                                <span id="message_error" style="color:red;"></span>
                                                <label for="message">Message</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <button type="submit" name="register" id="sendRegform" class="btn btn-primary py-3 px-5" onsubmit="regValidation();">Send Message</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="container-xxl pt-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="container-xxl pt-5 px-0">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14646.33957016109!2d85.2313902257879!3d23.40322975618406!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4de7839eaabcf%3A0x5b063620aeed454a!2sTilta%2C%20Jharkhand!5e0!3m2!1sen!2sin!4v1670923749205!5m2!1sen!2sin"
                             width="100%" height="450px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>

                            <!-- <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d227.78111405038402!2d84.0454076492088!3d24.013503983922355!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x398b89c5ac21b517%3A0x83e67e7ac47e4e98!2sTalab%20Rd%2C%20Chainpur%2C%20Jharkhand%20822110!5e0!3m2!1sen!2sin!4v1656220708905!5m2!1sen!2sin" frameborder="0" style="width: 100%; height: 450px; border:0;" allowfullscreen="true" aria-hidden="false" tabindex="0"> -->
                            <!-- </iframe> -->
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                                &copy; <a class="border-bottom text-secondary" href="#">its me</a>, All Right Reserved.
                            </div>
                            <div class="col-md-6 text-center text-md-end">

                                Designed By <a class="border-bottom text-secondary" href="#">Piyush</a>
